...
const productPages = [
  ...
  },
  {
    ...
    group: "Product",
    title: "What does the bank activity really say?",
    description: "See deposits, revenue behaviour, balances, negative days, NSFs and cash-flow movement across the statement period — without reconstructing it line by line.",
  ...
  },
  {
    ...
    group: "Product",
    title: "Does the borrower package actually hold together?",
    description: "Catch missing or duplicate documents, conflicting names and numbers, suspicious document signals and inconsistencies between what was submitted and what the evidence shows.",
  ...
  },
  {
    ...
    group: "Product",
    title: "Where does the deal fall outside our rules?",
    description: "Evaluate the file against your lender-defined thresholds, conditions and exceptions so the team can see exactly what passed, what failed and what needs judgment.",
  ...
  },
  {
    ...
    group: "Product",
    title: "What still needs an underwriter to decide?",
    description: "Bring unresolved conflicts, policy exceptions, risk signals and reviewer notes into one place so the remaining judgment is clear instead of buried across the file.",

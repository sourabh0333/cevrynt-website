...
import { HeroProductMotion } from "@/components/motion/hero-product-motion";
...
export default function Home() {
  return <><StoryMotion /><main id="main-content" className="art-home">
    <section id="hero-environment" className="art-hero" aria-labelledby="hero-title">
      ...
      <div className="art-hero__product"><HeroProductMotion /></div>
    ...
    <section id="workflow-environment" data-story-environment className="art-environment art-workflow" aria-labelledby="workflow-title">
    ...
    <section id="workspace-environment" data-story-environment className="art-environment art-workspace" aria-labelledby="workspace-title">
    ...
    <section id="policy-environment" data-story-environment className="art-environment art-policy" aria-labelledby="policy-title">
    ...
    <section id="investigation-environment" data-story-environment className="art-investigation" aria-labelledby="investigation-title">
    ...
    <section id="recommendation-environment" data-story-environment className="art-environment art-recommendation" aria-labelledby="recommendation-title">
    ...
    <section id="ecosystem-environment" data-story-environment className="art-environment art-ecosystem" aria-labelledby="ecosystem-title">
    ...
    <section id="control-environment" data-story-environment className="art-environment art-control" aria-labelledby="control-title">
